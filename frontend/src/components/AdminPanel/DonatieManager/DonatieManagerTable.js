...
const DonatieManagerTable = () => {
    ...
    const [columnDefs] = useState([
        ...
        { field: 'hoeveelheid', headerName: 'Hoeveelheid', filter: true },
        { field: 'naam', headerName: 'Naam', filter: true },
        { field: 'datum', headerName: 'Datum', filter: true },
    ]);
    ...
    useEffect(() => {
        ...
        fetch('http://api.localhost/api/Donatie', {
            method: 'GET',
            headers: {
...
export default DonatieManagerTable;
